...
## 1. Creation of a genomic mask   #### 1.1. Create coverage mask     
...
```
#### 3.5. Merge top SNPs in genomic regions  We then merge top SNPs together when they were closer than 10kb with the 
...
#### 5.1. Generate XP-EHH score for the sliding windows   Make XP-EHH output as a bed file:   
```shell    
